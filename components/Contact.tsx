      ...
      <div className="grid md:grid-cols-2 gap-16 items-start">
        <div>
          ...
          <p className="text-slate-600 mb-8 leading-relaxed">
            I'm always open to discussing new projects, collaborative research,
            or opportunities to be part of your tech team. Messages sent here go
